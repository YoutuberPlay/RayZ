...
| Бессознательное состояние | Игрок падает и приходит в сознание | Игрок «Survivor» (id = DAYZGUID, pos = <13212.8, 10124.8, 6.0>) без сознания --- Игрок «Выживший» (id = DAYZGUID, pos = <13212.8, 10124.8, 6.0>) пришел в сознание. |
| тест | тоже | 554 |
| тест | тоже | 554 |
| тест | тоже | 554 |
| тест | тоже | 554 |
